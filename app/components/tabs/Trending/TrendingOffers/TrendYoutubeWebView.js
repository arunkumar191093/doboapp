...
class TrendYoutubeWebView extends Component {
    render() {
        return (
            <View style={{ flex: 1 }}>
                <WebView
                ...
                <View style={{ position: 'absolute', bottom: 0, width: '100%', height: 40 }}>
                    <TouchableOpacity style={{ height: '100%', flexDirection: 'row-reverse', backgroundColor: Constants.LIGHT_GRADIENT_COLOR }}
                        ...
                        >
                            <IconComponent
                                name={this.props.data.values.wishList ? ImageConst['like-active'] : ImageConst['like-default']}
                                size={30}
                            />
                        </TouchableOpacity>
                    </TouchableOpacity>
...
export default TrendYoutubeWebView